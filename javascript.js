            ...
            <div class="space-y-6 pt-2">
                ...
                <div class="pt-2 space-y-2">
                    ...
                    <div class="grid grid-cols-3 landscape:sm:grid-cols-6 gap-3">
						...
						<div id="livestream-card" onclick="openLivestreamsMenu()" class="bg-slate-900 rounded-xl p-2.5 text-center cursor-pointer transition duration-500 animate-card-hover relative">
    
    						<!-- Lapisan Khusus Efek Border Merah Berkedip -->
    						<div class="absolute inset-0 border-2 border-rose-600 rounded-xl animate-pulse shadow-[0_0_15px_rgba(225,29,72,0.4)] pointer-events-none"></div>
    						...
    						<!-- Konten Menu (Dibuat z-10 agar berada di atas efek border) -->
    						<div class="relative z-10 h-16 bg-rose-500/10 rounded-lg flex items-center justify-center text-2xl mb-2">📺</div>
    							<span class="relative z-10 text-[11px] font-bold text-rose-100">Livestreams</span>
