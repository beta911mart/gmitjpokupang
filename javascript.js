...
function startDrag(e) {
    if (e.target === fab || fab.contains(e.target)) {
        ...
        // Offset tarikan jari terhadap ujung tombol
        dragOffsetX = clientX - fabRect.left;
        dragOffsetY = clientY - fabRect.top;
        
        // Konversi koordinat viewport menjadi koordinat relatif ke wadah aplikasi
        ...
        // Lepas default style CSS dan gunakan koordinat absolut baru
...
function onDrag(e) {
    ...
    // Titik posisi baru dihitung berdasarkan wadah aplikasi
    let newLeft = pointerViewportX - containerRect.left;
    let newTop = pointerViewportY - containerRect.top;
    
    // Kunci nilai minimum (0) dan maksimum (Lebar/Tinggi Body - Lebar/Tinggi Tombol)
